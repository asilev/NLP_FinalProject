...
\textbf{@ronen}\\
Figure \ref{fig:data_stats} summarizes the statistics of the data we used in our experiments, covering the authors (name and user ID), their area of work, the number of tweets we got using the Twitter4j API, and the number of tweets we ended up with after pre-processing (preparing the tweets in the format that YAP requires) and applying the YAP tool:\\
\begin{figure}[h!]
