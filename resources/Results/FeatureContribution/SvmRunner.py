...
features=("numOfMorphemes","averageWordSize","NumOfCharacters", "NumOfPunctuationMarks","AverageNumOfPunctuationMarks", "PosUsage", "AverageSentenceSize", "NumOfLongWords")
for feature in features:
	...
	for g in gammas:
		...
		for c in cs:
			...
			output = subprocess.Popen(["svm-predict.exe", "evaluation.svm.fc."+feature, "training.svm.fc."+feature+".model", "eval"],
