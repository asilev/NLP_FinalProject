...
os.system("java -jar svmprepare.jar -t training.svm.bobw -v evaluation.svm.bobw -m model.txt")
...
for g in gammas:
    ...
    for c in cs:
        ...
        os.system("svm-train.exe -t 1 -d 1 -r 0 -g "+str(g)+" -c "+str(c) + " training.svm.bobw")
        output = subprocess.Popen(["svm-predict.exe", "evaluation.svm.bobw", "training.svm.bobw.model", "eval"],
